 ...
 * @version $Id: JRsubViewer.java 4595 2011-09-08 15:55:10Z teodord $
 */
public class JRsubViewer extends javax.swing.JPanel implements JRHyperlinkListener
{
	private static final Log log = LogFactory.getLog(JRsubViewer.class);

	private static final long serialVersionUID = JRConstants.SERIAL_VERSION_UID;

	/**
	 * Maximum size (in pixels) of a buffered image that would be used by {@link JRsubViewer JRsubViewer} to render a report page.
	 * <p>
	...
	/** Creates new form JRsubViewer */
	public JRsubViewer(String fileName, boolean isXML) throws JRException
	{
	...
	/** Creates new form JRsubViewer */
	public JRsubViewer(InputStream is, boolean isXML) throws JRException
	{
		this(is, isXML, null);
	}
	...
	/** Creates new form JRsubViewer */
	public JRsubViewer(JasperPrint jrPrint)
	{
		this(jrPrint, null,null);
	}


	/** Creates new form JRsubViewer */
	public JRsubViewer(String fileName, boolean isXML, Locale locale) throws JRException
	{
	...
	/** Creates new form JRsubViewer */
	public JRsubViewer(InputStream is, boolean isXML, Locale locale) throws JRException
	{
	...
	/** Creates new form JRsubViewer */
	public JRsubViewer(JasperPrint jrPrint, Locale locale,String filename)
	{
		this(jrPrint, locale, null,filename);
	}


	/** Creates new form JRsubViewer */
	public JRsubViewer(String fileName, boolean isXML, Locale locale, ResourceBundle resBundle) throws JRException
	{
	...
	/** Creates new form JRsubViewer */
	public JRsubViewer(InputStream is, boolean isXML, Locale locale, ResourceBundle resBundle) throws JRException
	{
		initResources(locale, resBundle);
	...
	/** Creates new form JRsubViewer */
	public JRsubViewer(JasperPrint jrPrint, Locale locale, ResourceBundle resBundle,String filename)
	{
		initResources(locale, resBundle);
	...
	private void initComponents(final String filename) {
		...
		btnSave.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				btnSaveActionPerformed(evt,filename);
			}
		});
	...
	void btnSaveActionPerformed(java.awt.event.ActionEvent evt,String name) {//GEN-FIRST:event_btnSaveActionPerformed
		// Add your handling code here:
				...
				new Runnable()
				{
					public void run()
					{
						try
						{
							...
							JRsubViewer.this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
						...
						catch (Exception ex)
						{
							...
							JOptionPane.showMessageDialog(JRsubViewer.this, getBundleString("error.printing"));
						}
						finally
						{
							JRsubViewer.this.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
	...
	protected void paintPage(Graphics2D grx)
	{
		...
		catch(Exception e)
		{
			...
			SwingUtilities.invokeLater(new Runnable()
			{
				public void run()
				{
					JOptionPane.showMessageDialog(JRsubViewer.this, getBundleString("error.displaying"));
				}
			});
		}
	...
	*/
	class PageRenderer extends JLabel
	{
		...
		JRsubViewer viewer = null;

		public PageRenderer(JRsubViewer viewer)
		{
			this.viewer = viewer;
		}
