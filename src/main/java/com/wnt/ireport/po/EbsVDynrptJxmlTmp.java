...
public class EbsVDynrptJxmlTmp implements Serializable {
    ...
    /** full constructor */
    public EbsVDynrptJxmlTmp(String reportid, String reportidjxmlm, String reportidjxml, String ismain, String sheetname) {
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof EbsVDynrptJxmlTmp) ) return false;
        EbsVDynrptJxmlTmp castOther = (EbsVDynrptJxmlTmp) other;
